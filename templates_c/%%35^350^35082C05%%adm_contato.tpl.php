<?php /* Smarty version 2.6.26, created on 2010-05-05 15:57:20
         compiled from adm_contato.tpl */ ?>
<head>
...
<p class="heading">Cadastro de Contatos</p>
...
<div id="button">
    <div id="bt_salvar_materia" class="button_salvar" onclick="">
        <p class="button">Salvar</p>
    </div>
    <div id="bt_apagar_materia" class="button_apagar" onclick="">
        <p class="button">Apagar</p>
    </div>
    <div id="bt_adicionar_materia" class="button_adicionar" onclick="">
