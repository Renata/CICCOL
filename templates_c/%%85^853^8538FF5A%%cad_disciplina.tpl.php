		...
		<legend class="ui-widget ui-widget-header ui-corner-all">Disciplina</legend>
                   ...
                   <select id="cad_disciplina_semestre" name="cad_disciplina_semestre">
                    ...
                    <select id="cad_disciplina_materia" name="cad_disciplina_materia">
                        <option>Selecione</option>
                        <?php unset($this->_sections['cont_materia']);
$this->_sections['cont_materia']['name'] = 'cont_materia';
$this->_sections['cont_materia']['loop'] = is_array($_loop=$this->_tpl_vars['mat']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['cont_materia']['show'] = true;
$this->_sections['cont_materia']['max'] = $this->_sections['cont_materia']['loop'];
$this->_sections['cont_materia']['step'] = 1;
$this->_sections['cont_materia']['start'] = $this->_sections['cont_materia']['step'] > 0 ? 0 : $this->_sections['cont_materia']['loop']-1;
if ($this->_sections['cont_materia']['show']) {
    $this->_sections['cont_materia']['total'] = $this->_sections['cont_materia']['loop'];
    if ($this->_sections['cont_materia']['total'] == 0)
        $this->_sections['cont_materia']['show'] = false;
} else
    $this->_sections['cont_materia']['total'] = 0;
if ($this->_sections['cont_materia']['show']):

            for ($this->_sections['cont_materia']['index'] = $this->_sections['cont_materia']['start'], $this->_sections['cont_materia']['iteration'] = 1;
                 $this->_sections['cont_materia']['iteration'] <= $this->_sections['cont_materia']['total'];
                 $this->_sections['cont_materia']['index'] += $this->_sections['cont_materia']['step'], $this->_sections['cont_materia']['iteration']++):
$this->_sections['cont_materia']['rownum'] = $this->_sections['cont_materia']['iteration'];
$this->_sections['cont_materia']['index_prev'] = $this->_sections['cont_materia']['index'] - $this->_sections['cont_materia']['step'];
$this->_sections['cont_materia']['index_next'] = $this->_sections['cont_materia']['index'] + $this->_sections['cont_materia']['step'];
$this->_sections['cont_materia']['first']      = ($this->_sections['cont_materia']['iteration'] == 1);
$this->_sections['cont_materia']['last']       = ($this->_sections['cont_materia']['iteration'] == $this->_sections['cont_materia']['total']);
?>
                        <option><?php echo $this->_tpl_vars['mat'][$this->_sections['cont_materia']['index']]['materia']; ?>
</option>
                       <?php endfor; endif; ?>
                    </select><br/><br/>
