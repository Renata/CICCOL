<?php /* Smarty version 2.6.26, created on 2010-05-23 15:22:03
         compiled from alocar_professor.tpl */ ?>
...
?>
                    ...
                    <select id="cad_alocar_professor_professor">
                        <option>Selecione</option>
                        <?php unset($this->_sections['cont_professor']);
$this->_sections['cont_professor']['name'] = 'cont_professor';
$this->_sections['cont_professor']['loop'] = is_array($_loop=$this->_tpl_vars['prof']) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['cont_professor']['show'] = true;
$this->_sections['cont_professor']['max'] = $this->_sections['cont_professor']['loop'];
$this->_sections['cont_professor']['step'] = 1;
$this->_sections['cont_professor']['start'] = $this->_sections['cont_professor']['step'] > 0 ? 0 : $this->_sections['cont_professor']['loop']-1;
if ($this->_sections['cont_professor']['show']) {
    $this->_sections['cont_professor']['total'] = $this->_sections['cont_professor']['loop'];
    if ($this->_sections['cont_professor']['total'] == 0)
        $this->_sections['cont_professor']['show'] = false;
} else
    $this->_sections['cont_professor']['total'] = 0;
if ($this->_sections['cont_professor']['show']):

            for ($this->_sections['cont_professor']['index'] = $this->_sections['cont_professor']['start'], $this->_sections['cont_professor']['iteration'] = 1;
                 $this->_sections['cont_professor']['iteration'] <= $this->_sections['cont_professor']['total'];
                 $this->_sections['cont_professor']['index'] += $this->_sections['cont_professor']['step'], $this->_sections['cont_professor']['iteration']++):
$this->_sections['cont_professor']['rownum'] = $this->_sections['cont_professor']['iteration'];
$this->_sections['cont_professor']['index_prev'] = $this->_sections['cont_professor']['index'] - $this->_sections['cont_professor']['step'];
$this->_sections['cont_professor']['index_next'] = $this->_sections['cont_professor']['index'] + $this->_sections['cont_professor']['step'];
$this->_sections['cont_professor']['first']      = ($this->_sections['cont_professor']['iteration'] == 1);
$this->_sections['cont_professor']['last']       = ($this->_sections['cont_professor']['iteration'] == $this->_sections['cont_professor']['total']);
?>
                        <option><?php echo $this->_tpl_vars['prof'][$this->_sections['cont_professor']['index']]['professor']; ?>
</option>
                        <?php endfor; endif; ?>
                    </select><br/><br/>
